...
-- =============================== drop all tables (try until no red line message)================================
...
CREATE TABLE users (
    ...
    user_role NVARCHAR(50) CHECK (user_role IN ('Admin', 'Manager', 'User')),
...
CREATE TABLE requests (
	...
	organization_id UNIQUEIDENTIFIER,  -- JOIN REQUESTS
...
CREATE TABLE invite_join_requests (
	invite_join_request_id UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
	user_id UNIQUEIDENTIFIER NOT NULL,
	organization_id UNIQUEIDENTIFIER NOT NULL,

	title NVARCHAR(255),
	content NVARCHAR(MAX),
	cv_location NVARCHAR(255),
...
ALTER TABLE invite_join_requests
