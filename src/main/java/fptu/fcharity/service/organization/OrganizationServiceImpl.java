...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    public OrganizationDto updateOrganization(OrganizationDto organizationDto) throws IOException {
        ...
        OrganizationMember.OrganizationMemberRole userRole = checkRole(organization.getOrganizationId(), user.getUserId());
    ...
    public List<OrganizationDto> getOrganizationsByCeoOrManager(UUID ceoManagerId) {
        ...
        return organizationMemberRepository.findOrganizationMemberByUserUserId(ceoManagerId)
                .stream()
    ...
    public OrganizationDto getOrganizationByOrganizationIdAndCeoOrManager(UUID organizationId, UUID ceoManagerId) {
        OrganizationMember organizationMember = organizationMemberRepository.findOrganizationMemberByUserUserIdAndOrganizationOrganizationId(ceoManagerId, organizationId);
    ...
    private OrganizationDto convertToDTO(Organization organization) {
        ...
        dto.setCeoId(organization.getCeo().getUserId());
